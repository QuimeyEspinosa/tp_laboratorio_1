 ...
 * \return Si la verificacion falla la funcion retorna (-1) y si tiene exito retorna la longitud del array.
 */
int ll_len(LinkedList* this);

/**
 * \brief Retorna un puntero al nodo que se encuentra en el indice especificado.
 * \param this: Puntero a la LinkedList
 * \param nodeIndex: indice.
 * \return Si la verificacion falla la funcion retorna (NULL) y si tiene exito retorna el puntero al nodo.
 */
 ...
 * \param this: Puntero a la LinkedList
 * \param index: indice
 * \return Si la verificación falla la funcion retorna (NULL) y si tiene exito retorna el elemento.
 */
...
/**
 * \brief Elimina un elemento del LinkedList, en el indice especificado.
 * \param this: Puntero a la LinkedList
 * \param index: indice
 * \return Si la verificacion falla la funcion retorna (-1) y si tiene exito (0).
 */
 ...
 * \param this: Puntero a la LinkedList
 * \param pElement: puntero al elemento
 * \return Si la verificacion falla o no encuentra el elemento la funcion retorna (-1) y si encuentra el elemento retorna su indice.
 */
...
/**
 * \brief Desplaza los elementos e inserta en la posicion index.
 * \param this: Puntero a la LinkedList
 * \param index: indice
 * \param pElement: puntero al elemento
 * \return Si la verificacion falla la funcion retorna (-1) y si tiene exito (0).
 ...
 * \param this: Puntero a la LinkedList
 * \param index: indice
 * \return Si la verificacion falla la funcion retorna (NULL) y si tiene exito retorna el elemento.
 */
void* ll_pop(LinkedList* this,int index);

/**
 * \brief Comprueba si existe el elemento que se le pasa como parametro. Verificando que tanto el puntero this sea distintos de NULL.
 * \param this: Puntero a la LinkedList
 * \param pElement: puntero al elemento
 ...
 * \return Si la verificacion falla o no encuentra el elemento la funcion retorna (-1), si las listas difieren (0) y si ambas listas son iguales retorna (1).
 */
 ...
 * \param this: Puntero a la LinkedList
 * \return Si la verificación falla la funcion retorna (NULL) y si tiene exito retorna el nuevo array.
 */
 ...
 * \param this: Puntero a la LinkedList
 * \param (*pFunc): funcion que sera la encargada de determinar que elemento es mas grande que otro
 * \param orden: 1 asencente, 0 descendente
 * \return Verificando que tanto el puntero this como el puntero a la funcion pFunc sean distintos de NULL. Si la verificacion falla (-1) caso contrario retorna (1).
 */
